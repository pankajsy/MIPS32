...
void key_exp(void)
{
	unsigned int S[26] = { 3084996963, 1444465436,  4098901205, 2458369678,
						   817838151, 3472273920, 1831742393, 191210866,
						   2845646635, 1205115108,  3859550877, 2219019350,
						   578487823, 3232923592,  1592392065, 4246827834,
						   2606296307, 965764780, 3620200549, 1979669022,
						   339137495, 2993573264,  1353041737, 4007477506,
	...
	unsigned int i = 0;
	unsigned int j = 0;
	unsigned int i_mod = 26;
	unsigned int j_mod = 4;
    unsigned int sab = 0;
	unsigned int shift3 = 3;
    unsigned int ab = 0, lab = 0;
	...
	for (count = 78; (count > 0); count --)
	{
			...
			cout << "\n(32 - shift3)) = " << (32 - shift3);
			cout << "\n(sab << shift3) = " << (sab << shift3);
			cout << "\n sab >> (32 - shift3) = " << (sab >> (32 - shift3));
			...
			cout << "\n(32 - shift)) = " << (32 - shift);
			cout << "\n(lab << shift) = " << (lab << shift);
			cout << "\nlab >> (32 - abshift = " << (lab >> (32 - shift));

			
			
			B = L [j] = ((lab << shift) | (lab >> (32 - shift)));
